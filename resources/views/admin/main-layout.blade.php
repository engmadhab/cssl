...
<head>
  ...
  <title>Admin CSSL | {{isset($title)?$title:''}}</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost:8000/" target="_blank" class="nav-link">View site</a>
      </li>
    </ul>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="#">Admin CSSL</a>.</strong>
    All rights reserved.
