                ...
                <table class="table">
                  ...
                  @foreach ($newses as $news)
                    <tr>
                      ...
                      <td><img src="{{asset('uploads/news/'.$news->news_image)}}" width="100" alt=""></td>
                      <td><a class="btn btn-default" href="{{route('admin.news.edit', $news->id)}}"><i class="fas fa-edit"></i></a>
                      <a class="btn btn-default" href="#deleteModal{{$news->id}}" data-toggle="modal"><i class="fas fa-trash-alt"></i></a>
